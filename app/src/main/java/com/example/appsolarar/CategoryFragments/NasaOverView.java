...
public class NasaOverView extends Fragment {
    View v;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        NatureRefs = FirebaseDatabase.getInstance().getReference().child("Nasa");
    }
            ...
            protected void onBindViewHolder(@NonNull DataVH tutorVH, int i, @NonNull Data tutors) {
                ...
                tutorVH.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        detintent.putExtra("datarefs","Nasa");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_nasa_over_view, container, false);
    }
}